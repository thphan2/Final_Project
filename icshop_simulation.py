...
class Ice_creamShop:
    ...
    total_sec = 39600
    def __init__(self):
        exp_chef_num = random.randint(1, 3)
        new_chef_num = random.randint(0, 3)
        ...
        for i in range(exp_chef_num,exp_chef_num+new_chef_num):
        ...
        for i in range(exp_cashier_num,exp_cashier_num+new_cashier_num):
